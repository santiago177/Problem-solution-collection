...
def ARGS():
    token = getNextToken()[0]
    pred1 = ["token_par_izq"]
    pred2 = ["para", "limpiar", "segun", "mientras", "finfuncion", "finsubproceso", "finsubalgoritmo", "borrar", "repetir", "id", "leer", "definir", "escribir", "si", "esperar", "dimension"]
    if token in pred1:
        match("token_par_izq")
        T2()
    elif token in pred2:
...
def BLOCK():
    ...
    pred2 = ["leer", "para", "definir", "escribir", "limpiar", "segun", "mientras", "si", "borrar", "esperar", "repetir", "id", "dimension"]
    if token in pred1:
        return
    elif token in pred2:
        STORCOM()
...
def CALL():
    token = getNextToken()[0]
    pred1 = ["token_par_izq"]
    pred2 = ["token_igual", "token_mayor", "token_mas", "escribir", "token_o", "token_mayor_igual", "milisegundos", "minutos", "token_y", "mientras", "finfuncion", "finmientras", "finsubproceso", "borrar", "token_mod", "token_pot", "leer", "para", "finalgoritmo", "definir", "si", "id", "token_dosp", "token_dif", "token_pyc", "finsi", "token_menor", "token_menos", "limpiar", "entonces", "finpara", "token_mul", "finsubalgoritmo", "token_div", "segun", "repetir", "hacer", "finproceso", "sino", "caso", "finsegun", "token_cor_der", "hasta", "de", "token_coma", "token_menor_igual", "segundos", "token_par_der", "esperar", "dimension", "con"]
    if token in pred1:
        match("token_par_izq")
        OPEXPR()
        L3()
...
def COM():
    token = getNextToken()[0]
    pred1 = ["leer", "definir", "escribir", "limpiar", "id", "borrar", "esperar", "dimension"]
    if token in pred1:
        COMID()
        match("token_pyc")
    else:
...
def EXPR():
    token = getNextToken()[0]
    pred1 = ["token_neg", "token_menos", "verdadero", "token_entero", "falso", "token_real", "token_cadena", "id"]
    pred2 = ["token_par_izq"]
    if token in pred1:
        TOK()
        T7()
...
def L5():
    token = getNextToken()[0]
    pred1 = ["leer", "para", "definir", "escribir", "limpiar", "segun", "mientras", "si", "borrar", "esperar", "repetir", "id", "dimension"]
...
def OP():
    ...
    if token in pred1:
        ...
        match("token_coma")
    elif token in pred15:
        match("token_pot")
    else:
        syntax_error(set(pred1+pred2+pred3+pred4+pred5+pred6+pred7+pred8+pred9+pred10+pred11+pred12+pred13+pred14+pred15))


def OPEXPR():
    token = getNextToken()[0]
    pred1 = ["token_neg", "token_menos", "verdadero", "token_entero", "token_par_izq", "falso", "token_real", "token_cadena", "id"]
...
def PROC():
    ...
    if token in pred1:
        ...
        syntax_error(set(pred1+pred2), True)
...
def STORCOM():
    ...
    pred2 = ["leer", "definir", "escribir", "limpiar", "id", "borrar", "esperar", "dimension"]
    if token in pred1:
        STATEMENT()
    elif token in pred2:
        COM()
...
def T1():
    token = getNextToken()[0]
    pred1 = ["token_asig"]
    pred2 = ["para", "token_par_izq", "limpiar", "mientras", "finfuncion", "finsubproceso", "finsubalgoritmo", "borrar", "segun", "repetir", "id", "leer", "definir", "escribir", "si", "esperar", "dimension"]
    if token in pred1:
        match("token_asig")
        match("id")
    elif token in pred2:
...
def T3():
    token = getNextToken()[0]
    pred1 = ["tecla"]
    pred2 = ["token_neg", "token_menos", "verdadero", "token_entero", "token_par_izq", "falso", "token_real", "token_cadena", "id"]
    if token in pred1:
        match("tecla")
    elif token in pred2:
        EXPR()
...
def T5():
    token = getNextToken()[0]
    pred1 = ["token_igual", "token_mayor", "token_mas", "escribir", "token_o", "token_mayor_igual", "milisegundos", "token_par_izq", "token_y", "mientras", "finfuncion", "finmientras", "finsubproceso", "borrar", "token_mod", "token_pot", "leer", "para", "finalgoritmo", "definir", "si", "id", "token_dosp", "token_dif", "token_menor", "token_pyc", "finsi", "minutos", "token_menos", "limpiar", "entonces", "finpara", "token_mul", "finsubalgoritmo", "token_div", "segun", "repetir", "hacer", "finproceso", "sino", "caso", "finsegun", "token_cor_der", "hasta", "de", "token_coma", "token_menor_igual", "segundos", "token_par_der", "esperar", "dimension", "con"]
    pred2 = ["token_igual", "token_mayor", "token_mas", "escribir", "token_o", "token_mayor_igual", "milisegundos", "minutos", "token_y", "mientras", "finfuncion", "finmientras", "finsubproceso", "borrar", "token_mod", "token_pot", "leer", "para", "finalgoritmo", "definir", "si", "id", "token_dosp", "token_dif", "token_pyc", "finsi", "token_menor", "token_menos", "limpiar", "entonces", "finpara", "token_mul", "finsubalgoritmo", "token_div", "segun", "repetir", "hacer", "finproceso", "sino", "caso", "finsegun", "token_cor_der", "hasta", "de", "token_coma", "token_menor_igual", "segundos", "token_par_der", "esperar", "dimension", "con"]
    if token in pred1:
        CALL()
    elif token in pred2:
...
def T6():
    token = getNextToken()[0]
    pred1 = ["token_mas", "token_o", "token_mayor_igual", "token_dif", "token_menos", "token_pot", "token_y", "token_mul", "token_coma", "token_menor_igual", "token_div", "token_mod", "token_menor", "token_mayor", "token_igual"]
    pred2 = ["minutos", "escribir", "milisegundos", "finproceso", "mientras", "finfuncion", "finmientras", "finsubproceso", "id", "leer", "para", "finalgoritmo", "definir", "hacer", "token_pyc", "finsi", "de", "limpiar", "segun", "finpara", "sino", "finsubalgoritmo", "token_dosp", "entonces", "repetir", "borrar", "caso", "finsegun", "token_cor_der", "hasta", "si", "token_coma", "segundos", "token_par_der", "esperar", "dimension", "con"]
    if token in pred1:
        OP()
        EXPR()
    elif token in pred2:
...
def TIPO():
    ...
    if token in pred1:
        ...
        syntax_error(set(pred1+pred2+pred3+pred4+pred5+pred6+pred7+pred8))
